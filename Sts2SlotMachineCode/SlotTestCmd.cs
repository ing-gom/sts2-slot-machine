...
{
    private static readonly string[] Outcomes = { "relic", "1", "2", "3", "full", "bomb", "lose" };
    private static readonly string[] Completions = { "relic", "1", "2", "3", "full", "bomb", "lose", "courier" };

    public override string CmdName => "slot";
    public override string Args => "[relic|1|2|3|full|bomb|lose|courier]";
