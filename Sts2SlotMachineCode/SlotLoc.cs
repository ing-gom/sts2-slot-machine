...
internal static class SlotLoc
{
    ...
    internal static readonly Dictionary<string, (string en, string ko, string zh)> UiStrings = new()
    {
        ...
        ["UI.POTION_WON"]      = ("★ Potion won! ★", "★ 포션 획득! ★", "★ 获得药水！★"),
        ["UI.POTION_ROW"]      = ("Middle row ×3 → win potion", "가운데 줄 3개 → 포션 획득", "中间行×3 → 获得药水"),
        ["UI.CARDREMOVE_WON"]  = ("★ Free card removal! ★", "★ 무료 카드 제거! ★", "★ 免费移除卡牌！★"),
        ["UI.CARDREMOVE_ROW"]  = ("Middle row ×3 → remove a card", "가운데 줄 3개 → 카드 제거", "中间行×3 → 移除卡牌"),
        ["UI.CARDUPGRADE_WON"] = ("★ Free card upgrade! ★", "★ 무료 카드 강화! ★", "★ 免费升级卡牌！★"),
        ["UI.CARDUPGRADE_ROW"] = ("Middle row ×3 → upgrade a card", "가운데 줄 3개 → 카드 강화", "中间行×3 → 升级卡牌"),
        ["UI.POTIONGRANT_WON"] = ("★ Free potion! ★", "★ 무료 포션 획득! ★", "★ 获得免费药水！★"),
        ["UI.POTIONGRANT_ROW"] = ("Middle row ×3 → win a random potion", "가운데 줄 3개 → 랜덤 포션 획득", "中间行×3 → 获得随机药水"),
        ...
        ["UI.TAKEN_BY_PARTNER"] = ("A teammate won this relic!  Taken from your shop.",
        ...
        // cabinet skins
        ["UI.SKIN_ALL"]        = ("All skins", "모든 스킨", "全部皮肤"),
        ["UI.SKIN_CLASSIC"]    = ("Classic", "클래식", "经典"),
        ["UI.SKIN_GOLD"]       = ("Gold", "황금", "黄金"),
        ["UI.SKIN_FOREST"]     = ("Forest", "숲", "森林"),
        ["UI.SKIN_ICE"]        = ("Ice", "얼음", "冰霜"),
        ["UI.SKIN_VOID"]       = ("Void", "공허", "虚空"),
        ["UI.SKIN_NEON"]       = ("Neon", "네온", "霓虹"),
        ["UI.SKIN_RUBY"]       = ("Ruby", "루비", "红宝石"),
        ["UI.SKIN_EMERALD"]    = ("Emerald", "에메랄드", "翡翠"),
        ["UI.SKIN_SAPPHIRE"]   = ("Sapphire", "사파이어", "蓝宝石"),
        ["UI.SKIN_OBSIDIAN"]   = ("Obsidian", "흑요석", "黑曜石"),
        ["UI.SKIN_FIRE"]       = ("Fire", "화염", "烈焰"),
        ["UI.SKIN_LIGHTNING"]  = ("Lightning", "번개", "闪电"),
        ["UI.SKIN_POISON"]     = ("Poison", "맹독", "剧毒"),
        ["UI.SKIN_OCEAN"]      = ("Ocean", "심해", "深海"),
        ["UI.SKIN_SAKURA"]     = ("Sakura", "벚꽃", "樱花"),
        ["UI.SKIN_AURORA"]     = ("Aurora", "오로라", "极光"),
        ["UI.SKIN_GALAXY"]     = ("Galaxy", "은하", "银河"),
        ["UI.SKIN_CANDY"]      = ("Candy", "캔디", "糖果"),
        ["UI.SKIN_PRISM"]      = ("Prism", "프리즘", "棱镜"),
        ["UI.SKIN_BRONZE"]     = ("Bronze", "청동", "青铜"),
        ["UI.SKIN_JADE"]       = ("Jade", "비취", "翡翠玉"),
        ["UI.SKIN_AMETHYST"]   = ("Amethyst", "자수정", "紫水晶"),
        ["UI.SKIN_CORAL"]      = ("Coral", "산호", "珊瑚"),
        ["UI.SKIN_STORM"]      = ("Storm", "폭풍", "风暴"),
        ["UI.SKIN_SHADOW"]     = ("Shadow", "그림자", "暗影"),
        ["UI.SKIN_MAGMA"]      = ("Magma", "마그마", "熔岩"),
        ["UI.SKIN_FROST"]      = ("Frost", "서리", "霜冻"),
        ["UI.SKIN_MINT"]       = ("Mint", "민트", "薄荷"),
        ["UI.SKIN_ROSE"]       = ("Rose", "장미", "玫瑰"),
        ["UI.SKIN_CYBER"]      = ("Cyber", "사이버", "赛博"),
        ["UI.SKIN_ANVIL"]      = ("Anvil", "모루", "铁砧"),
        ["UI.SKIN_BREW"]       = ("Alchemy", "연금", "炼金"),
        ["UI.SKIN_UNLOCKED"]   = ("★ New skin unlocked: {0}!", "★ 새 스킨 해금: {0}!", "★ 解锁新皮肤：{0}！"),
        ["UI.SKIN_GRID_TITLE"] = ("Skins  ({0}/{1})", "스킨 목록  ({0}/{1})", "皮肤列表  ({0}/{1})"),
        ["UI.SKIN_HINT_HOVER"] = ("Hover a locked skin to see how to unlock it", "잠긴 스킨에 마우스를 올리면 해금 조건이 표시됩니다", "将鼠标悬停在锁定皮肤上查看解锁条件"),
        ["UI.UNLOCK_NET"]      = ("🔒 Reach {0} net gold", "🔒 누적 순익 {0}골드 달성", "🔒 累计净收益达 {0} 金币"),
        ["UI.UNLOCK_SPINS"]    = ("🔒 Spin {0} times", "🔒 {0}회 스핀", "🔒 旋转 {0} 次"),
        ["UI.UNLOCK_RELICS"]   = ("🔒 Win {0} relics", "🔒 유물 {0}개 획득", "🔒 赢得 {0} 件遗物"),
        ["UI.UNLOCK_BOMBS"]    = ("🔒 Hit {0} bombs", "🔒 폭탄 {0}회 맞기", "🔒 触发 {0} 次炸弹"),
        ["UI.UNLOCK_JACKPOTS"] = ("🔒 Hit the jackpot", "🔒 잭팟 당첨", "🔒 中一次大奖"),
        // effect breakdown fragments (composed dynamically from each skin's params; {0} = a signed value)
        ["UI.EFF_NONE"]        = ("No effect (cosmetic)", "효과 없음 (코스메틱)", "无效果（纯装饰）"),
        ["UI.EFF_GOLD"]        = ("Gold reward {0}", "골드 보상 {0}", "金币奖励 {0}"),
        ["UI.EFF_RELIC"]       = ("Relic chance {0}", "유물 확률 {0}", "遗物概率 {0}"),
        ["UI.EFF_BOMB"]        = ("Bomb chance {0}", "폭탄 확률 {0}", "炸弹概率 {0}"),
        ["UI.EFF_REFUND"]      = ("Miss refund {0}", "꽝 환급 {0}", "未中返还 {0}"),
        // DRAMATIC odds reshaping (whole bucket ×N or removed)
        ["UI.EFF_RELICX"]      = ("Relic chance {0}", "유물 확률 {0}", "遗物概率 {0}"),
        ["UI.EFF_NORELIC"]     = ("No relic wins", "유물 당첨 없음", "无遗物中奖"),
        ["UI.EFF_LINEX"]       = ("Gold-win chance {0}", "골드 당첨 확률 {0}", "金币中奖概率 {0}"),
        ["UI.EFF_NOLINE"]      = ("No gold wins", "골드 당첨 없음", "无金币中奖"),
        ["UI.EFF_FULLX"]       = ("Jackpot(777) chance {0}", "잭팟(777) 확률 {0}", "头奖(777)概率 {0}"),
        ["UI.EFF_NOFULL"]      = ("No 777 jackpot", "777 잭팟 없음", "无777头奖"),
        ["UI.EFF_BOMBX"]       = ("Bomb chance {0}", "폭탄 확률 {0}", "炸弹概率 {0}"),
        ["UI.EFF_NOBOMB"]      = ("No bombs", "폭탄 없음", "无炸弹"),
        ["UI.EFF_POTIONS"]     = ("Potions on reels (2× relic rate)", "포션 릴 추가 (유물 2배 확률)", "转轮加入药水（遗物2倍概率）"),
        ["UI.EFF_CARDREMOVE"]  = ("Free card removal (3%)", "무료 카드 제거 (3%)", "免费移除卡牌（3%）"),
        ["UI.EFF_CARDUPGRADE"] = ("Free card upgrade (3%)", "무료 카드 강화 (3%)", "免费升级卡牌（3%）"),
        ["UI.EFF_POTIONVEND"]  = ("Free random potion (10%)", "무료 랜덤 포션 (10%)", "免费随机药水（10%）"),
        ["UI.EFF_BOMBSPARE"]   = ("Bombs spare relic wins", "폭탄이 유물 당첨은 못 없앰", "炸弹不夺走遗物"),
        // effect archetype labels
        ["UI.FILTER_ALL"]      = ("All", "전체", "全部"),
        ["UI.CAT_BALANCED"]    = ("Balanced", "밸런스형", "平衡型"),
        ["UI.CAT_TRADEOFF"]    = ("Trade-off", "트레이드오프형", "取舍型"),
        ["UI.CAT_MAXROLL"]     = ("Focused", "극대화형", "专精型"),
        ["UI.CAT_SPECIAL"]     = ("Special", "특수형", "特殊型"),
